...
print("<div id='algo1'><h2>Decision Tree</h2><progress style='position:absolute; left:-10px;' value='%f' max='1'></progress><br><h3>%d %s</h3></div>" %(acc1, accc1, s))



print("<div class='algorithm'><h2>Random Forest</h2><progress value='%f' max='1'></progress><br><h3>%d %s</h3></div>" % (acc2, accc2, s))

print("<div class='algorithm'><h2>Naive Bayes</h2><progress style='position:absolute; left:-10px;' value='%f' max='1'></progress><br><h3>%d %s</h3></div>" % (acc3, accc3, s))

print("<div id='algo2'><h2>kNearest Neighbour</h2><progress style='position:absolute; left:18px;' value='%f' max='1'></progress><br><h3>%d %s</h3></div>" % (acc4, accc4, s))
